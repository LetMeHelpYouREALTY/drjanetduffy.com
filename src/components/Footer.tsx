      ...
      <div className="container-max">
        ...
        <div className="section-padding">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-1">
              <div className="flex items-center space-x-2 mb-4">
                ...
                <div>
                  ...
                  <p className="text-luxury-gold text-sm">Las Vegas Real Estate Expert 🎰</p>
                </div>
              </div>
              ...
              <div className="space-y-2">
                <a
                  ...
                  className="flex items-center space-x-2 text-luxury-gold hover:text-white transition-colors duration-200"
                >
            ...
            {/* Services */}
            <div>
              <h4 className="text-lg font-semibold mb-4 text-luxury-gold">Services</h4>
              <ul className="space-y-2">
            ...
            {/* Neighborhoods */}
            <div>
              <h4 className="text-lg font-semibold mb-4 text-luxury-gold">Popular Areas</h4>
              <ul className="space-y-2">
